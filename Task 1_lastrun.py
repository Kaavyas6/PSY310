...
expName = 'Task 1'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Kaavya\\Desktop\\PSY310\\PSYCHOPY\\Signal Detection\\Task 1_lastrun.py',
