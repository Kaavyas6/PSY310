...
expName = 'Task 4'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Kaavya\\Desktop\\PSY310\\PSYCHOPY\\Sequential Motor Learning\\Task 4_lastrun.py',
