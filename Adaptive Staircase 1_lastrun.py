...
expName = 'Adaptive Staircase 1'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Kaavya\\Desktop\\PSY310\\PSYCHOPY\\Adaptive Staircase\\Adaptive Staircase 1_lastrun.py',
